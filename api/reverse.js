...
API = function (params, callback, options) {
    ...
    var promise = new Promise(function (resolve, reject) {
        ...
        else if (!utils.has(params, API.PARAM_LATITUDE)) {
          return reject(new APIError.MissingArgumentError(API.SERVICE_NAME, 'params.' + API.PARAM_LATITUDE));
        }
        else if (!utils.has(params, API.PARAM_LONGITUDE)) {
          return reject(new APIError.MissingArgumentError(API.SERVICE_NAME, 'params.' + API.PARAM_LONGITUDE));
        }
...
var ReverseQuery = function () {
};
API.ReverseQuery = ReverseQuery;


API.SERVICE_NAME = 'reverse';
API.SERVICE_METHOD = 'GET';

API.PARAM_POSTAL_CODE = 'postal_code';
API.PARAM_LATITUDE = 'latitude';
API.PARAM_LONGITUDE = 'longitude';
